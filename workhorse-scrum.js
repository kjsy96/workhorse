  ...
  // Project Plan & Scope control (renderProjectPlanControl and friends,
  // called just above in renderProjectToolbar) moved to its own file,
  // workhorse-project-plan.js -- see issue #58. It isn't Scrum-specific
  // (shown in both Kanban and Scrum mode), it only lived here because both
  // were rendered from this same renderProjectToolbar() call site.
